...
class Point(object):
    def __init__(self,x,y):
        ...
        self.originalx = x
        self.originaly = y
        self.current_x = self.originalx
        self.current_y = self.originaly
        self.distance = 0
    ...
    def move_to(self, x, y):
        P = Point(x,y)
        self.distance = self.distance + self.get_distance_from(P)
        self.x = x
        self.y = y
    ...
    def get_distance_from_start(self):
        x = self.x - self.originalx
        y = self.y - self.originaly
        return (x**2 + y**2)**.5
    ...
    def closer_to(self,p2,p3):
        a = self.x - p2.x
        b = self.y - p2.y
        distance_from_p2 = (a**2 + b**2)**.5
        c = self.x - p3.x
        d = self.y - p3.y
        distance_from_p3 = (c**2 + d**2)**.5
